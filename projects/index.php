<html>
  ...
  <head>
    <title>Projects | Braden Tiernan</title>
    ...
    <meta property="og:title" content="Projects | Braden Tiernan" />
    ...
    <meta property="og:site_name" content="Projects | Braden Tiernan"/>
    <meta property="og:url" content="https://protohub.online/" />
    <meta name="DC.title" content="Projects | Braden Tiernan" />
  ...
  <body>
    ...
    <div class="s1">
      <div class="s1s1">
        ...
        <h1 class="wsc1 s1s1s1">PROJECTS.</h1>
        ...
        <p class="wsc1 s1s1s2"><a onClick="window.scroll({top: 999999, left: 0, behavior: 'smooth'});" class="link">contact me &rarr;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onClick="cp('/');" class="link">head home &rarr;</a></p>
        <div class="s1s1s4"></div>
        <h1 class="wsc1 s1s1s1sc1">All Projects.</h1>
        <?php
          for ($i = count($gv1);$i > 0; $i--) {
            $temp = ["",""];
            $temp2 = 0;
            $temp3 = "";
            if ($gv1[$i - 1][7]) {
        ...
        ?>
        <p class="wsc1 s1s1s2 s1s1s2sc1 linksc3">&bull; That's all for now! &bull;</p>
        <div class="s1s1s4"></div>
    ...
    <div class="s3"><?php for ($i = 0; $i < 20; $i++) {echo "<div class='s3sc1'>";}; for ($i = 0; $i < 20; $i++) {echo "</div>";}?><h2 class="s3s1"><i>Projects.</i></h2></div>
